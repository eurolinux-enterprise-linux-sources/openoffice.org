...
Patch7:  openoffice.org-2.3.0.ooo76649.httpencoding.patch
Patch8:  openoffice.org-2.3.1.ooo83878.unopkg.enablelinking.patch
Patch9:  openoffice.org-2.4.0.ooo86080.unopkg.bodge.patch
Patch10: openoffice.org-3.0.0.ooo88341.sc.verticalboxes.patch
Patch11: workspace.fchints01.patch
Patch12: openoffice.org-3.0.0.ooo87970.vcl.samenamesubs.patch
Patch13: openoffice.org-3.0.0.ooo91924.svx.consistentordering.patch
Patch14: openoffice.org-3.0.1.oooXXXXX.fpicker.allformatsonsave.patch
Patch15: openoffice.org-3.1.0.ooo98137.filter.redeclared-variables.patch
Patch16: openoffice.org-2.2.0.gccXXXXX.solenv.javaregistration.patch
Patch17: openoffice.org-3.1.0.oooXXXXX.solenv.allowmissing.patch
Patch18: ooo-build.ooo2497.filter.svg.patch
Patch19: openoffice.org-3.1.0.ooo61927.sw.ww6.unicodefontencoding.patch
Patch20: workspace.slideshow1.patch
Patch21: openoffice.org-3.1.0.ooo101274.opening-a-directory.patch
Patch22: openoffice.org-3.1.0.ooo101354.filter.xhtml.do-not-label-list-headers.patch
Patch23: openoffice.org-3.1.0.ooo101355.filter.no-variables-in-keys.patch
Patch24: workspace.locales33a.patch
Patch25: openoffice.org-3.1.0.ooo102061.sc.cellanchoring.patch
Patch26: openoffice.org-3.1.0.ooo102142.sd.resleak.patch
Patch27: workspace.sdfindall.patch
Patch28: workspace.dr73.patch
Patch29: openoffice.org-3.1.1.ooo104329.dbaccess.primarykeys.patch
Patch30: openoffice.org-3.1.1.ooo64671.canvas.add-support-for-font-pitch.patch
Patch31: openoffice.org-3.1.1.ooo109280.sal.justcoredump.patch
Patch32: workspace.vcl106.patch
Patch33: openoffice.org-3.1.1.ooo105784.vcl.sniffscriptforsubs.patch
Patch34: openoffice.org-3.2.0.ooo105827.filter.xpath-on-rtf-not-allowed.patch
Patch35: workspace.gsminhibit.patch
Patch36: workspace.vcl107.patch
Patch37: workspace.hb33patches1.patch
Patch38: workspace.cmcfixes67.patch
Patch39: workspace.srb1.patch
Patch40: workspace.thbfixes10.patch
Patch41: workspace.vcl108.patch
Patch42: workspace.pythonssldedux.patch
Patch43: openoffice.org-3.2.0.ooo106502.svx.fixspelltimer.patch
Patch44: openoffice.org-3.2.0.ooo47279.sd.objectsave.safe.patch
Patch45: workspace.sw33bf03.patch
Patch46: workspace.writerfilter07.patch
Patch47: openoffice.org-3.3.0.ooo108246.svx.hide-sql-group-when-inactive.patch
Patch48: workspace.sw33bf02.patch
Patch49: workspace.fwk139.patch
Patch50: workspace.cmcfixes70.patch
Patch51: workspace.s390xport02.patch
Patch52: openoffice.org-3.3.0.ooo108637.sfx2.uisavedir.patch
Patch53: openoffice.org-3.2.0.ooo108846.sfx2.qstartfixes.patch
Patch54: workspace.calc53.patch
Patch55: workspace.impress188.patch
Patch56: openoffice.org-3.2.0.ooo95369.sw.sortedobjs.patch
Patch57: workspace.odfmetadata4.patch
Patch58: workspace.tl80.patch
Patch59: openoffice.org-3.2.0.ooo110142.svx.safercolornames.patch
Patch60: workspace.vcl111.patch
Patch61: workspace.sw33bf04.patch
Patch62: workspace.mba33issues01.patch
Patch63: openoffice.org-3.3.0.ooo111446.writerfilter.avoidcrash.patch
Patch64: workspace.chart47.patch
Patch65: openoffice.org-3.3.0.ooo111699.svx.nullfield.patch
Patch66: openoffice.org-3.3.0.ooo111758.sd.xerror.patch
Patch67: workspace.extras330.patch
Patch68: openoffice.org-3.2.0.ooo111741.extras.malformed-xml-file.patch
Patch69: openoffice.org-3.2.0.ooo111886.sw.layout.workaround.patch
Patch70: workspace.cmcfixes64.patch
Patch71: workspace.cmcfixes75.patch
Patch72: workspace.writerfilter08.patch
Patch73: openoffice.org-3.3.0.ooo112059.sw.avoid-null-ptr-deref.patch
Patch74: workspace.os140.patch
Patch75: workspace.vcl112.patch
Patch76: openoffice.org-3.3.0.ooo107490.cppu.lifecycle.patch
Patch77: openoffice.org-3.3.0.ooo100686.wizards.types.not.mediatypes.patch
Patch78: workspace.vcl113.patch
Patch79: openoffice.org-3.3.0.ooo112363.accessibility.badindex.patch
Patch80: openoffice.org-3.3.0.ooo112384.sw.export.doc.styledoesntexist.patch
Patch81: workspace.gtkfpicker9.patch
...
Group: Applications/Productivity
Requires: %{name}-core = %{epoch}:%{version}-%{release}
Requires: font(:lang=fi), autocorr-fi
Obsoletes: openoffice.org-i18n < 1.9.0
...
Requires: font(:lang=lt), hunspell-lt, hyphen-lt
Obsoletes: openoffice.org-i18n < 1.9.0
...
%patch7  -p1 -b .ooo76649.httpencoding.patch
%patch8  -p1 -b .ooo83878.unopkg.enablelinking.patch
%patch9  -p1 -b .ooo86080.unopkg.bodge.patch
%patch10 -p1 -b .ooo88341.sc.verticalboxes.patch
%patch11 -p1 -b .workspace.fchints01.patch
%patch12 -p1 -b .ooo87970.vcl.samenamesubs.patch
%patch13 -p1 -b .ooo91924.svx.consistentordering.patch
%patch14 -p1 -b .oooXXXXX.fpicker.allformatsonsave.patch
%patch15 -p0 -b .ooo98137.filter.redeclared-variables.patch
%patch16 -p0 -b .gccXXXXX.solenv.javaregistration.patch
%patch17 -p1 -b .oooXXXXX.solenv.allowmissing.patch
%patch18 -p1 -b .ooo2497.filter.svg.patch
%patch19 -p1 -b .ooo61927.sw.ww6.unicodefontencoding.patch
%patch20 -p1 -b .workspace.slideshow1.patch
%patch21 -p0 -b .ooo101274.opening-a-directory.patch
%patch22 -p0 -b .ooo101354.filter.xhtml.do-not-label-list-headers.patch
%patch23 -p0 -b .ooo101355.filter.no-variables-in-keys.patch
%patch24 -p1 -b .workspace.locales33a.patch
%patch25 -p0 -b .ooo102061.sc.cellanchoring.patch
%patch26 -p0 -b .ooo102142.sd.resleak.patch
%patch27 -p0 -b .workspace.sdfindall.patch
%patch28 -p0 -b .workspace.dr73.patch
%patch29 -p0 -b .ooo104329.dbaccess.primarykeys.patch
%patch30 -p0 -b .ooo64671.canvas.add-support-for-font-pitch.patch
%patch31 -p1 -b .ooo109280.sal.justcoredump.patch
%patch32 -p0 -b .workspace.vcl106.patch
%patch33 -p0 -b .ooo105784.vcl.sniffscriptforsubs.patch
%patch34 -p0 -b .ooo105827.filter.xpath-on-rtf-not-allowed.patch
%patch35 -p1 -b .workspace.gsminhibit.patch
%patch36 -p1 -b .workspace.vcl107.patch
%patch37 -p0 -b .workspace.hb33patches1.patch
%patch38 -p1 -b .workspace.cmcfixes67.patch
%patch39 -p1 -b .workspace.srb1.patch
%patch40 -p0 -b .workspace.thbfixes10.patch
%patch41 -p0 -b .workspace.vcl108.patch
%patch42 -p1 -b .workspace.pythonssldedux.patch
%patch43 -p1 -b .ooo106502.svx.fixspelltimer.patch
%patch44 -p0 -b .ooo47279.sd.objectsave.safe.patch
%patch45 -p1 -b .workspace.sw33bf03.patch
%patch46 -p0 -b .workspace.writerfilter07.patch
%patch47 -p1 -b .ooo108246.svx.hide-sql-group-when-inactive.patch
%patch48 -p1 -b .workspace.sw33bf02.patch
%patch49 -p0 -b .workspace.fwk139.patch
%patch50 -p1 -b .workspace.cmcfixes70.patch
%patch51 -p1 -b .workspace.s390xport02.patch
%patch52 -p1 -b .ooo108637.sfx2.uisavedir.patch
%patch53 -p1 -b .ooo108846.sfx2.qstartfixes.patch
%patch54 -p0 -b .workspace.calc53.patch
%patch55 -p0 -b .workspace.impress188.patch
%patch56 -p1 -b .ooo95369.sw.sortedobjs.patch
%patch57 -p1 -b .workspace.odfmetadata4.patch
%patch58 -p1 -b .workspace.tl80.patch
%patch59 -p0 -b .ooo110142.svx.safercolornames.patch
%patch60 -p1 -b .workspace.vcl111.patch
%patch61 -p1 -b .workspace.sw33bf04.patch
%patch62 -p1 -b .workspace.mba33issues01.patch
%patch63 -p0 -b .ooo111446.writerfilter.avoidcrash.patch
%patch64 -p0 -b .workspace.chart47.patch
%patch65 -p0 -b .ooo111699.svx.nullfield.patch
%patch66 -p0 -b .ooo111758.sd.xerror.patch
%patch67 -p1 -b .workspace.extras330.patch
%patch68 -p1 -b .ooo111741.extras.malformed-xml-file.patch
%patch69 -p0 -b .ooo111886.sw.layout.workaround.patch
%patch70 -p1 -b .workspace.cmcfixes64.patch
%patch71 -p1 -b .workspace.cmcfixes75.patch
%patch72 -p0 -b .workspace.writerfilter08.patch
%patch73 -p1 -b .ooo112059.sw.avoid-null-ptr-deref.patch
%patch74 -p1 -b .workspace.os140.patch
%patch75 -p1 -b .workspace.vcl112.patch
%patch76 -p1 -b .ooo107490.cppu.lifecycle.patch
%patch77 -p0 -b .ooo100686.wizards.types.not.mediatypes.patch
%patch78 -p0 -b .workspace.vcl113.patch
%patch79 -p0 -b .ooo112363.accessibility.badindex.patch
%patch80 -p0 -b .ooo112384.sw.export.doc.styledoesntexist.patch
%patch81 -p0 -b .workspace.gtkfpicker9.patch
...
unzip solver/%{OFFICEUPD}/unxlng*/bin/minimizer/presentation-minimizer.oxt -d $RPM_BUILD_ROOT%{baseinstdir}/extensions/presentation-minimizer.oxt
chmod -x $RPM_BUILD_ROOT%{baseinstdir}/extensions/presentation-minimizer.oxt/help/component.txt
...
%files langpack-hi_IN	-f hi.filelist
%defattr(-,root,root,-)
...
%defattr(-,root,root,-)
%docdir %{baseinstdir}/extensions/presentation-minimizer.oxt/help
...
* Tue Jul 13 2010 David Tardon <dtardon@redhat.com> - 1:3.2.1-19.5
- Resolves: rbhz#612374 closing while search for text box open causes
  segfault

* Thu Jul 01 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.1-19.4
- Resolves: rhbz#577812 Indic cursoring problems

* Fri Jun 18 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.1-19.3
- Related: rhbz#602729 avoid div by 0 crash

* Wed Jun 16 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.1-19.2
- Resolves: rhbz#602729 fix make check for headless libgcj

* Wed Jun 16 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.1-19.1
- Resolves: rhbz#602729 update to OOo 3.2.1

* Mon Jun 14 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.0-12.9
- Resolves: rhbz#603043/ooo#112386 improve gtk fpicker stability
- Resolves: rhbz#603013/ooo#112363 avoid a11y crash

* Thu Jun 10 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.0-12.8
- Resolves: rhbz#602631 dual head fixes add workspace.ooo321gsl05.patch

* Thu Jun 10 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.0-12.7
...
* Sat Jun 05 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.0-12.6
- Resolves: rhbz#600674 CVE-2010-0395 Execution of Python code when browsing macros (caolanm)

* Wed May 26 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.0-12.5
- Resolves: rhbz#595211 malformed XML configuration files (dtardon)

* Tue Apr 27 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.0-12.4
- Resolves: rhbz#586446 postit draw crash after changing printer

* Tue Apr 27 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.0-12.3
- Resolves: rhbz#578082 [or_IN, pa_IN][openoffice.org] - Default font
  not taking lohit-* (dtardon)

* Tue Apr 13 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.0-12.2
- Resolves: rhbz#577812 for cursor travelling block vowel+virama+vowel
  together 

* Tue Mar 09 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.2.0-12.1
- Resolves: rhbz#567764 update to OOo 3.2.0

* Fri Jan 15 2010 Caolán McNamara <caolanm@redhat.com> - 1:3.1.1-19.22
- Related: rhbz#553257 FTBFS

* Wed Dec 09 2009 Caolán McNamara <caolanm@redhat.com> - 1:3.1.1-19.21
...
* Fri Nov 27 2009 Caolán McNamara <caolanm@redhat.com> - 1:3.1.1-19.20
- Resolves: rhbz#541222 add
  openoffice.org-3.2.0.ooo107260.dtrans.clipboard.shutdown.patch (caolanm)

* Mon Nov 23 2009 Caolán McNamara <caolanm@redhat.com> - 1:3.1.1-19.19
...
* Thu Nov 17 2009 Caolán McNamara <caolanm@redhat.com> - 1:3.1.1-19.18
- Resolves: ooo#59648 sw .doc export scaling (caolanm)

* Tue Nov 10 2009 Caolán McNamara <caolanm@redhat.com> - 1:3.1.1-19.17
- Resolves: rhbz#533841 ooo#105710 svx loadstorenumbering (caolanm)

* Thu Nov 05 2009 Caolán McNamara <caolanm@redhat.com> - 1:3.1.1-19.16
- Resolves: ooo#106523 fix pdf/A export on x86_64 (caolanm)

* Thu Nov 05 2009 Caolán McNamara <caolanm@redhat.com> - 1:3.1.1-19.15
...
* Wed Oct 28 2009 Caolán McNamara <caolanm@redhat.com> - 1:3.1.1-19.14
...
* Mon Oct 19 2009 Caolán McNamara <caolanm@redhat.com> - 1:3.1.1-19.13
...
* Thu Oct 15 2009 Caolán McNamara <caolanm@redhat.com> - 1:3.1.1-19.12
