						...
						uno::RuntimeException)
{
	...
	{
		if (ScUnoHelpFunctions::GetInt16FromAny( aValue ))
			aAppOpt.SetStatusFunc(true);
		else
			aAppOpt.SetStatusFunc(false);
		bSaveApp = TRUE;
	}
						...
						uno::RuntimeException)
{
	...
	else if (aString.EqualsAscii( SC_UNONAME_STBFUNC ))	aRet <<= (sal_Int16) (aAppOpt.GetStatusFunc() ? true : false);
	else if (aString.EqualsAscii( SC_UNONAME_SCALE ))
	{
		INT16 nZoomVal = 0;
