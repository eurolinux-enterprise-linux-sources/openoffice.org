								...
								OUString &rReplacement)
{
	...
	// No multi-word entries are allowed
	static const OUString aSpaceDelim (A2OU (" "));
	sal_Int32 nSpacePos = rDicWord.indexOf (aSpaceDelim);
	if (-1 != nSpacePos)
		rDicWord = rDicWord.copy (0, nSpacePos);

	nSpacePos = rReplacement.indexOf (aSpaceDelim);
	if (-1 != nSpacePos)
		rReplacement = rReplacement.copy (0, nSpacePos);
}
